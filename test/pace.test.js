...
for (const file of ['src/shared/action-pace-config.js', 'src/shared/delay-generator.js', 'src/shared/backoff.js', 'src/shared/action-pace-controller.js', 'src/shared/rate-limiter.js', 'src/content/comment-surface-stability.js', 'src/content/comment-pagination-loader.js']) vm.runInNewContext(fs.readFileSync(file, 'utf8'), context);
